...
##CASE_stm32mp1##    $@PC> make -f $PWD/../Makefile.sdk.stm32mp1 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb TF_A_DEVICETREE=<your_board_name> EXTDT_DIR=<externaldt_path> EXTDT_DIR_TF_A_SERIAL=<externaldt_tfa_programmer_path> SIGN_ENABLE=<sign_enable> ENCRYPT_ENABLE=<encrypt_enable> stm32
...
##CASE_stm32mp1##        $MP13> make -f $PWD/../Makefile.sdk.stm32mp1 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-sdcard TF_A_DEVICETREE=stm32mp135f-dk EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp1/tf-a metadata stm32
##CASE_stm32mp1##        $MP15> make -f $PWD/../Makefile.sdk.stm32mp1 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-sdcard TF_A_DEVICETREE=stm32mp157f-dk2 EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp1/tf-a metadata stm32
##CASE_stm32mp1##      Example for runtime FIP binaries
##CASE_stm32mp1##        $MP15> make -f $PWD/../Makefile.sdk.stm32mp1 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-sdcard TF_A_DEVICETREE=stm32mp157f-dk2 EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp1/tf-a fip
##CASE_stm32mp1##        $MP13> make -f $PWD/../Makefile.sdk.stm32mp1 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-sdcard TF_A_DEVICETREE=stm32mp135f-dk  EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp1/tf-a fip
##CASE_stm32mp1##      Example for flashing binaries
##CASE_stm32mp1##        $MP15> make -f $PWD/../Makefile.sdk.stm32mp1 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb    TF_A_DEVICETREE=stm32mp157f-dk2 EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp1/tf-a stm32
##CASE_stm32mp1##        $MP13> make -f $PWD/../Makefile.sdk.stm32mp1 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-serial TF_A_DEVICETREE=stm32mp135f-dk  EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp1/tf-a stm32
##CASE_stm32mp1##      Example for flashing FIP binaries
##CASE_stm32mp1##        $MP15> make -f $PWD/../Makefile.sdk.stm32mp1 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb    TF_A_DEVICETREE=stm32mp157f-dk2 EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp1/tf-a fip
##CASE_stm32mp1##        $MP13> make -f $PWD/../Makefile.sdk.stm32mp1 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-serial TF_A_DEVICETREE=stm32mp135f-dk  EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp1/tf-a fip
...
##CASE_stm32mp2##        $MP21> make -f $PWD/../Makefile.sdk.stm32mp2 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-sdcard TF_A_DEVICETREE=stm32mp215f-dk  EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp2/a35-td/tf-a metadata stm32
##CASE_stm32mp2##        $MP23> make -f $PWD/../Makefile.sdk.stm32mp2 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-sdcard TF_A_DEVICETREE=stm32mp235f-dk  EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp2/a35-td/tf-a metadata stm32
##CASE_stm32mp2##        $MP25> make -f $PWD/../Makefile.sdk.stm32mp2 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-nor    TF_A_DEVICETREE=stm32mp257f-ev1 EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp2/a35-td/tf-a metadata stm32
##CASE_stm32mp2##      Example for runtime FIP binaries
##CASE_stm32mp2##        $MP21> make -f $PWD/../Makefile.sdk.stm32mp2 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-sdcard TF_A_DEVICETREE=stm32mp215f-dk  FIP_CONFIG=optee-sdcard EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp2/a35-td/tf-a fip
##CASE_stm32mp2##        $MP23> make -f $PWD/../Makefile.sdk.stm32mp2 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-sdcard TF_A_DEVICETREE=stm32mp235f-dk  FIP_CONFIG=optee-sdcard EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp2/a35-td/tf-a fip
##CASE_stm32mp2##        $MP25> make -f $PWD/../Makefile.sdk.stm32mp2 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-nor    TF_A_DEVICETREE=stm32mp257f-ev1 FIP_CONFIG=optee-nor EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp2/a35-td/tf-afip
##CASE_stm32mp2##      Example for flashing binaries
##CASE_stm32mp2##        $MP21> make -f $PWD/../Makefile.sdk.stm32mp2 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb TF_A_DEVICETREE=stm32mp215f-dk  EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp2/a35-td/tf-a stm32
##CASE_stm32mp2##        $MP23> make -f $PWD/../Makefile.sdk.stm32mp2 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb TF_A_DEVICETREE=stm32mp235f-dk  EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp2/a35-td/tf-a stm32
##CASE_stm32mp2##        $MP25> make -f $PWD/../Makefile.sdk.stm32mp2 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb TF_A_DEVICETREE=stm32mp257f-ev1 EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp2/a35-td/tf-a stm32
##CASE_stm32mp2##      Example for flashing FIP binaries
##CASE_stm32mp2##        $MP21> make -f $PWD/../Makefile.sdk.stm32mp2 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb TF_A_DEVICETREE=stm32mp215f-dk  FIP_CONFIG=optee-programmer-usb EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp2/a35-td/tf-a fip
##CASE_stm32mp2##        $MP23> make -f $PWD/../Makefile.sdk.stm32mp2 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb TF_A_DEVICETREE=stm32mp235f-dk  FIP_CONFIG=optee-programmer-usb EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp2/a35-td/tf-a fip
##CASE_stm32mp2##        $MP25> make -f $PWD/../Makefile.sdk.stm32mp2 DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb TF_A_DEVICETREE=stm32mp257f-ev1 FIP_CONFIG=optee-programmer-usb EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp2/a35-td/tf-a fip
...
##CASE_stm32mp2-m33td##        $MP21> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-sdcard TF_A_DEVICETREE=stm32mp215f-dk-cm33tdcid-ostl-sdcard EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp2/m33-td/tf-a metadata stm32
##CASE_stm32mp2-m33td##        $MP23> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-sdcard TF_A_DEVICETREE=stm32mp235f-dk-cm33tdcid-ostl-sdcard EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp2/m33-td/tf-a metadata stm32
##CASE_stm32mp2-m33td##        $MP25> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-emmc   TF_A_DEVICETREE=stm32mp257f-ev1-cm33tdcid-ostl-emmc  EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp2/m33-td/tf-a metadata stm32
##CASE_stm32mp2-m33td##      Example for runtime FIP binaries
##CASE_stm32mp2-m33td##        $MP21> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-sdcard TF_A_DEVICETREE=stm32mp215f-dk-cm33tdcid-ostl-sdcard  FIP_CONFIG=optee-sdcard EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp2/m33-td/tf-a fip
##CASE_stm32mp2-m33td##        $MP23> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-sdcard TF_A_DEVICETREE=stm32mp235f-dk-cm33tdcid-ostl-sdcard  FIP_CONFIG=optee-sdcard EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp2/m33-td/tf-a fip
##CASE_stm32mp2-m33td##        $MP25> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-emmc   TF_A_DEVICETREE=stm32mp257f-ev1-cm33tdcid-ostl-emmc FIP_CONFIG=optee-emmc EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A=stm32mp2/m33-td/tf-a fip
##CASE_stm32mp2-m33td##      Example for flashing binaries
##CASE_stm32mp2-m33td##        $MP21> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb TF_A_DEVICETREE=stm32mp215f-dk-cm33tdcid-ostl-serial-ca35tdcid EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp2/m33-td/tf-a stm32
##CASE_stm32mp2-m33td##        $MP23> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb TF_A_DEVICETREE=stm32mp235f-dk-cm33tdcid-ostl-serial-ca35tdcid EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp2/m33-td/tf-a stm32
##CASE_stm32mp2-m33td##        $MP25> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb TF_A_DEVICETREE=stm32mp257f-ev1-cm33tdcid-ostl-serial-ca35tdcid EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp2/m33-td/tf-a stm32
##CASE_stm32mp2-m33td##      Example for flashing FIP binaries
##CASE_stm32mp2-m33td##        $MP21> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb TF_A_DEVICETREE=stm32mp215f-dk-cm33tdcid-ostl-serial-ca35tdcid  FIP_CONFIG=optee-programmer-usb EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp2/m33-td/tf-a fip
##CASE_stm32mp2-m33td##        $MP23> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb TF_A_DEVICETREE=stm32mp235f-dk-cm33tdcid-ostl-serial-ca35tdcid  FIP_CONFIG=optee-programmer-usb EXTDT_DIR=$EXTDT_DIR EXTDT_DIR_TF_A_SERIAL=stm32mp2/m33-td/tf-a fip
...
##CASE_stm32mp2-m33td##      Example for flashing binaries
##CASE_stm32mp2-m33td##        $MP2x> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb    TF_A_DEVICETREE=<your_CUBE_MX_board_name> EXTDT_DIR=<cubemx_output_dir> EXTDT_DIR_TF_A_SERIAL=ExtMemLoader/DeviceTree/tf-a stm32
##CASE_stm32mp2-m33td##        $MP2x> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-serial TF_A_DEVICETREE=<your_CUBE_MX_board_name> EXTDT_DIR=<cubemx_output_dir> EXTDT_DIR_TF_A_SERIAL=ExtMemLoader/DeviceTree/tf-a stm32
##CASE_stm32mp2-m33td##      Example for flashing FIP binaries
##CASE_stm32mp2-m33td##        $MP2x> make -f $PWD/../Makefile.sdk.stm32mp2-m33td DEPLOYDIR=$FIP_DEPLOYDIR_ROOT/arm-trusted-firmware TF_A_CONFIG=optee-programmer-usb    TF_A_DEVICETREE=<your_CUBE_MX_board_name> FIP_CONFIG=optee-programmer-usb EXTDT_DIR=<cubemx_output_dir> EXTDT_DIR_TF_A_SERIAL=ExtMemLoader/DeviceTree/tf-a fip
